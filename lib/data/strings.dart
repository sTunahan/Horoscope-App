class Strings {
  static const String AppName = "Horoscope Guide";

  static const List<String> Horoscope_Name = [
    "Koc",
    "Boga",
    "Ikizler",
    "Yengec",
  ...
  static const List<String> Horoscope_History = [
    "21 Mart - 20 Nisan",
    "21 Nisan - 21 Mayıs",
    "22 Mayıs - 22 Haziran",
  ...
  static const List<String> Horoscope_GeneralFeature = [
    "\tGenel Özellikler\n\n"
